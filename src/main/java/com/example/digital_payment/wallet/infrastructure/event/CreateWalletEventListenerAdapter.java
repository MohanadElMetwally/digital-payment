...
@Component
public class CreateWalletEventListenerAdapter {
    private final CreateWalletUseCase createWalletUseCase;

    public CreateWalletEventListenerAdapter(CreateWalletUseCase createWalletUseCase) {
        this.createWalletUseCase = createWalletUseCase;
    }

    @ApplicationModuleListener
    public void on(UserRegisteredEvent event) {
        createWalletUseCase.handle(event);
    }
}