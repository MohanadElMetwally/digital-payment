...
@Component("INTERNET_PROVIDER")
public class InternetProviderGatewayAdapter implements ProviderGatewayPort {
    ...
    public InternetProviderGatewayAdapter(RestTemplate restTemplate,
