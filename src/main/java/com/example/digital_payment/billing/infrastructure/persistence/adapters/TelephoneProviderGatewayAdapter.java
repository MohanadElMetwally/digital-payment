...
@Component("TELEPHONE_PROVIDER")
public class TelephoneProviderGatewayAdapter implements ProviderGatewayPort {
    ...
    public TelephoneProviderGatewayAdapter(RestTemplate restTemplate,
