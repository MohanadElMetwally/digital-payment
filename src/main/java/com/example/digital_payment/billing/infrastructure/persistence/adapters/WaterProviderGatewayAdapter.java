...
@Component("WATER_PROVIDER")
public class WaterProviderGatewayAdapter implements ProviderGatewayPort {
    ...
    public WaterProviderGatewayAdapter(RestTemplate restTemplate,
